...
var SET_BALANCE = exports.SET_BALANCE = "SET_BALANCE";
var DEPOSIT = exports.DEPOSIT = 'DESPOSIT';
var WITHDRAW = exports.WITHDRAW = 'WITHDRAW';
var FETCH_BITCOIN = exports.FETCH_BITCOIN = 'FETCH_BITCOIN';
...
var _verifyPlainObject = __webpack_require__(25);
...
var _wallet = __webpack_require__(76);

var _wallet2 = _interopRequireDefault(_wallet);

var _Loot = __webpack_require__(75);
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement('hr', null),
        _react2.default.createElement(_Loot2.default, null),
        _react2.default.createElement(
            'div',
            null,
            'Powered By ',
            _react2.default.createElement(
                'a',
                { target: '_blank', href: 'https://www.coindesk.com/price' },
                'Coindesk'
            )
        )
    );
...
var _bitcoin = __webpack_require__(79);

var _bitcoin2 = _interopRequireDefault(_bitcoin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.combineReducers)({ balance: _balance2.default, bitcoin: _bitcoin2.default });
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(3);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(15);var _assign=__webpack_require__(4);var emptyFunction=__webpack_require__(2);var EventListener=__webpack_require__(14);var getActiveElement=__webpack_require__(18);var shallowEqual=__webpack_require__(19);var containsNode=__webpack_require__(16);var focusNode=__webpack_require__(17);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(11);var hyphenateStyleName=__webpack_require__(38);var camelizeStyleName=__webpack_require__(36);/**
...
var _mapDispatchToProps = __webpack_require__(57);

var _mapDispatchToProps2 = _interopRequireDefault(_mapDispatchToProps);

var _mapStateToProps = __webpack_require__(58);
...
var _selectorFactory = __webpack_require__(60);
...
var _verifySubselectors = __webpack_require__(61);
...
exports.withdraw = exports.desposit = exports.setBalance = undefined;
...
var desposit = exports.desposit = function desposit(_desposit) {
    return {
...
var withdraw = exports.withdraw = function withdraw(withdrawal) {
    return {
...
exports.fetchBitcoin = undefined;

var _constants = __webpack_require__(7);

var fetchBitcoin = exports.fetchBitcoin = function fetchBitcoin() {
    return function (dispatch) {
        return fetch('https://api.coindesk.com/v1/bpi/currentprice.json').then(function (response) {
            return response.json();
        }).then(function (json) {
            return dispatch({ type: _constants.FETCH_BITCOIN, bitcoin: json });
        });
    };
};
...
var _bitcoin = __webpack_require__(74);
...
var Loot = exports.Loot = function (_Component) {
    _inherits(Loot, _Component);

    function Loot() {
        _classCallCheck(this, Loot);

        return _possibleConstructorReturn(this, (Loot.__proto__ || Object.getPrototypeOf(Loot)).apply(this, arguments));
    }
    ...
    _createClass(Loot, [{
        ...
        key: 'computeBitcoin',
        value: function computeBitcoin() {
            var bitcoin = this.props.bitcoin;
...
exports.default = (0, _reactRedux.connect)(function (state) {
    return state;
}, { fetchBitcoin: _bitcoin.fetchBitcoin })(Loot);
...
var _balance = __webpack_require__(73);
...
var Wallet = exports.Wallet = function (_Component) {
    ...
    function Wallet() {
        ...
        _this.updateBalance = function (event) {
            _this.setState({ balance: parseInt(event.target.value, 10) });
        };

        _this.desposit = function () {
            _this.props.desposit(_this.state.balance);
        };

        _this.withdraw = function () {
            _this.props.withdraw(_this.state.balance);
        };

        _this.state = { balance: undefined };
        return _this;
    }
    ...
    _createClass(Wallet, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { className: 'input-wallet',
                    onChange: this.updateBalance }),
                _react2.default.createElement(
                    'button',
                    { className: 'btn-desposit', onClick: this.desposit },
                    'Desposit'
                ),
                _react2.default.createElement(
                    'button',
                    { className: 'btn-withdraw', onClick: this.withdraw },
                    'Withdraw'
                )
            );
        }
...
}, { desposit: _balance.desposit, withdraw: _balance.withdraw })(Wallet);
...
var _sfcookies = __webpack_require__(69);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var BALANCE_COOKIE = 'BALANCE_COOKIES';
...
var balance = function balance() {
    ...
    switch (action.type) {
        ...
        case constants.DEPOSIT:
            balance = state + action.desposit;
            break;
        case constants.WITHDRAW:
            balance = state - action.withdrawal;
            break;
        default:
            balance = parseInt((0, _sfcookies.read_cookie)(BALANCE_COOKIE), 10) || state;
    }
    (0, _sfcookies.bake_cookie)(BALANCE_COOKIE, balance);
    return balance;
};
